...
<div class="searchWrap">
 ...
 <div class="text_bg" style="height: 450px;">
    ...
    <div style="float: right;width: 75%;">
        <iframe name="orgUserList" id="orgUser" src="leaderPageList.jsp" width="100%"  scrolling="no" frameborder="0"></iframe>
    </div>
</div>
...
//    orgTree.reAsyncChildNodes(orgTreeNode, "refresh");
    ...
    function viewOrgNode(event, treeId, treeNode) {
    	$("#orgUser").attr("src","leaderPageList.jsp?id="+treeNode.id+"&name="+treeNode.organizationName);
        _resetFrameHeight();
    }
