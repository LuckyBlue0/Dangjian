...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background: #f6ebe5;">
		...
		<div class="text_bg noneborder" id="bt">
			<form
				action="${baseURL}/partydevelopment/partydevelopmentAction!ajaxUpdate.action"
				method="post" id="id_form_add">
				<table class="tableCommon mt5" width="100%" border="0"
					cellspacing="0" cellpadding="0"
					dataSrc="${baseURL}/partydevelopment/partydevelopmentAction!ajaxView.action?id=${param.id}">
					<tbody>
						...
						<tr>
							...
							<td width="30%" colspan="2"
								name="tbPartyDevelopmentMenberPO.userName">
							</td>
							<td rowspan="4">
								<input t name="tbPartyDevelopmentMenberPO.portraitPic"
									id="imgPath" type="hidden" />
						...
						<tr>
							...
							<td width="30%" colspan="2"
								name="tbPartyDevelopmentMenberPO.name">
							</td>
						</tr>
						<tr>
							<td width="130" class="tdBlue">
							...
							<td width="30%" colspan="2"
								name="tbPartyDevelopmentMenberPO.mobile">
							</td>
						</tr>
						<tr>
							...
							<td width="35%" colspan="2"
								name="tbPartyDevelopmentMenberPO.sexDesc">
							</td>
						</tr>
						<tr>
							<td colspan="4">
						...
						<tr>
							...
							<td width="35%" name="tbPartyDevelopmentMenberPO.idCard">
							</td>
							<td width="150" class="tdBlue">
								民族
							</td>
						...
						<tr>
							...
							<td width="30%" colspan="3"
								name="tbPartyDevelopmentMenberPO.organizationIdentityDesc">
							</td>
						</tr>
						<tr>
							<td width="130" class="tdBlue">
							...
							<td width="30%" colspan="3"
								name="tbPartyDevelopmentMenberPO.organizationName">
							</td>
						</tr>
						<tr>
							<td width="150" class="tdBlue">
						...
						<tr>
							...
							<td colspan="3" name="tbPartyDevelopmentMenberPO.note">
							</td>
						</tr>
					</tbody>
				</table>
