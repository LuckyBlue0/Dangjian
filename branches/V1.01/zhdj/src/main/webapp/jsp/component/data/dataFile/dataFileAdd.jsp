...
<form action="${baseURL}/datafile/datafileAction!ajaxAdd.action" method="post" id="org_add" enctype="multipart/form-data">
	  ...
	  // $('#org_add').attr("action","${baseURL}/videofile/videofileAction!uploadFile.action?dir=videoFile"); 
	   ...
	   var myDate = new Date();
		...
		$("#progress").show();
	     ...
	     $('#org_add').attr("action","${baseURL}/datafile/datafileAction!ajaxAdd.action"); 
   }
</script>
