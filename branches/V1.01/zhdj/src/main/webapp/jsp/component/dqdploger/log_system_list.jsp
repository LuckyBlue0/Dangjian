...
<form action="${baseURL}/dqdploger/dqdploger!systemLogSearch.action" method="post" id="id_form_search">
<div class="text_bg">
    <div class="searchWrap">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                            ...
                            <td>
                                <table class="search" width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td >操作时间：</td>
                                        <td >
                                            <input class="form120px"  onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',maxDate:'#F{$dp.$D(\'endTime\')||\'%y-%M-%d\'}',autoPickDate:true});" name="searchValue.startDate" type="text" value="" id="startTime"/> -
            ...
            success:function (result) {
                if ("0" == result.code) {
                    var list1 = new ListTable(
                            {
                                title:[
                                    {width:"65%", name:"fileName", showName:"文件名"},
                                    {width:"15%", name:"size", showName:"大小(m)"},
                                    {width:"20%", name:"op", showName:"操作", isOperationColumn:true}
                                ],
                                operations:[
                                    {name:"下载", permission:"",event:function (index, content) {
                                        document.getElementsByName("downFrame")[0].src="logFileDown.jsp?fileName="+content.fileName;
                                    }}
                                ],
...
<iframe name="downFrame" style="display: none" >
