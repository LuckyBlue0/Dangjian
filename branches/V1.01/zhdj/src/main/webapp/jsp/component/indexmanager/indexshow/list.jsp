...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background: #f6ebe5;">
		...
		<div class="text_bg">
			<!-- 新闻类型信息搜索表单 -->
			<form
				action="${baseURL}/indexshow/indexshowAction!ajaxSearch.action"
										...
										<td>
											<table class="search" width="100%" border="0" cellspacing="0"
												...
												<tr>
													...
													<td width="35">
														<input name="searchValue.proName" />
													</td>
													<td align="right">
...
function _doSignlChange(formId, content, status) {
	$.ajax({
				url : '${baseURL}/indexshow/indexshowAction!ajaxChangeState.action?tbProjectInfoPO.id='
						+ content.id + '&tbProjectInfoPO.status=' + status,
				type : 'post',
				dataType : 'json',
				success : function(result) {
					if ('0' == result.code) {
			...
			<div id="partyMenber_list"
				delUrl="${baseURL}/indexshow/indexshowAction!ajaxBatchDelete.action"></div>
			<div id="tip"></div>
