...
<jsp:include page="../../../common/dqdp_vars.jsp">
    <jsp:param name="permission" value="hotNewsAdd"></jsp:param>
</jsp:include>
<head>
...
<form action="${baseURL}/news/hotNewsInfo/hotNewsInfoAction!ajaxSave.action" method="post" id="id_form_add">
    ...
    <table class="tableCommon mt5" width="100%" border="0" cellspacing="0" cellpadding="0" >
        ...
        <tbody>
		        ...
		        <tr>
		            <td  class="tdBlue"><span style="color: red">*</span>&nbsp;封面图片</td>
		            <td>
		            	<img src="${baseURL}/jsp/web/images/default.jpg" id="pic" height="150" width="200" alt="" />
                        <input type="hidden" readonly="readonly" id="path" name="tbHotNewsPO.imgPath" placeholder="图片建议尺寸：360像素 * 200像素" valid="{must:true,tip:'封面图片',fieldType:'pattern'}"/>
				...
				<tr>
		            ...
		            <td colspan="3">
		               <textarea name="tbHotNewsPO.bodyDigest" id="bodyDigest" valid="{must:true,tip:'摘要',fieldType:'pattern'}"></textarea>
		            </td>
		        </tr>
				<tr>
		            <td class="tdBlue"><span style="color: red">*</span>&nbsp;正文</td>
		            <td colspan="3">
		               <textarea name="tbHotNewsPO.content" id="content" valid="{must:true,tip:'正文',fieldType:'pattern'}"></textarea>
		            </td>
		        </tr>
				<tr>
		            <td class="tdBlue">来源</td>
		            <td colspan="3">
	...
	<div class="toolBar">
	    <div align="center">
	    	<input class="greenbtn mr10" type="button" id="save" permission="hotNewsAdd" value="保存"/>&nbsp;
