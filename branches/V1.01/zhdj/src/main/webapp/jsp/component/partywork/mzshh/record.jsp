...
<jsp:include page="../../../common/dqdp_vars.jsp">
    <jsp:param name="permission" value="democrticlifeRecord"></jsp:param>
</jsp:include>
<head>
...
<form action="${baseURL}/democrticLife/democrticLifeAction!ajaxSaveRecord.action" method="post" id="id_form_search">
    <div class="searchWrap">
        <div class="title">
            <h2 class="icon1">生活会记录</h2>
        </div>
    </div>
    ...
    <table class="tableCommon mt5" width="100%" border="0" cellspacing="0" cellpadding="0" dataSrc="${baseURL}/democrticLife/democrticLifeAction!ajaxView.action?id=${param.id}">
        <tbody>
        <tr>
            <td class="tdBlue">标题<input type="hidden" name="tbDemocraticLifePO.id" id="democrticLifeId"/></td>
            <td colspan="3" name="tbDemocraticLifePO.title">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3">
               <textarea rows="6" cols="80" name="tbDemocraticLifePO.record" id="record" ></textarea>
            </td>
        </tr>
        </tbody>
    </table>
...
<div class="toolBar">
    <div align="center">
    	<input class="greenbtn mr10" type="button" id="save" permission="democrticlifeRecord" value="完成"/>&nbsp;
 ...
 var userMap = new HashMap();
  $(document).ready(function(){
	  ...
	  KindEditor.ready(function(K) {
			editor1 = K.create('textarea[name="tbDemocraticLifePO.record"]', {
			...
			afterCreate : function() {
	            ...
	            this.sync(); 
	            $('#id_form_search').find('textarea[name="tbDemocraticLifePO.record"]').val(K('textarea[name="tbDemocraticLifePO.record"]').val());
	        }  
		})});
  });
