...
<form action="${baseURL}/meeting/meetingAction!ajaxSave.action" method="post" id="id_form_search">
    ...
    <div class="text_bg noneborder" id="bt">
	    <table class="tableCommon mt5"  border="0" cellspacing="0" cellpadding="0">
	        <tbody>
	        <tr>
	            <td class="tdBlue" width="100px;"><span style="color: red">*</span>&nbsp;标题</td>
	            <td  >
	        ...
	        <tr>
	            ...
	            <td>
	            	<input type="radio" dictType="meetingWay" defaultValue="0" name="tbMeetingPO.way" id="way" valid="{must:true,tip:'会议召开方式',fieldType:'pattern'}"/>
	            </td>
	        </tr>
	        <tr>
	        ...
	        <tr>
	            ...
	            <td >
	               <input type="checkbox" style="width: 15px;height: 10px;" value="1" name="tbMeetingPO.smsNotice" id="smsNotice" />
...
<div class="toolBar">
    <div align="center">
    	<input class="greenbtn mr10" type="button" id="save" permission="meetingAdd" value="保存"/>&nbsp;
