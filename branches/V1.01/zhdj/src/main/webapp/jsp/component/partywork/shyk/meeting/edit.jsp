...
<jsp:include page="../../../../common/dqdp_vars.jsp">
    ...
    <jsp:param name="permission" value="meetingEdit"></jsp:param>
</jsp:include>
<head>
...
<form action="${baseURL}/meeting/meetingAction!ajaxSave.action" method="post" id="id_form_search">
    <div class="searchWrap">
        <div class="title">
            <h2 class="icon1">会议详情</h2>
        </div>
    </div>
    <div class="text_bg noneborder" id="bt">
    <table class="tableCommon mt5" width="100%" border="0" cellspacing="0" cellpadding="0" dataSrc="${baseURL}/meeting/meetingAction!ajaxView.action?id=${param.id}">
        <tbody>
        <tr>
            <td class="tdBlue"><span style="color: red">*</span>&nbsp;标题</td>
            <td  >
            	<input type="hidden" name="tbMeetingPO.id" id="meetingId"/>
                <input type="text" id="title" name="tbMeetingPO.title" valid="{must:true,tip:'标题',fieldType:'pattern'}"/>&nbsp;&nbsp;&nbsp;
                <span style="color: red">*</span>
            </td>
        </tr>
        <tr>
            <td class="tdBlue"><span style="color: red">*</span>&nbsp;会议类型</td>
            <td >
                <select dictType="meetingType" defaultTip="" name="tbMeetingPO.type" id="type" valid="{must:true,tip:'会议类型',fieldType:'pattern'}"/>
            </td>
        </tr>
        <tr>
            <td  class="tdBlue"><span style="color: red">*</span>&nbsp;会议召开方式</td>
            <td>
            	<input type="radio" dictType="meetingWay" name="tbMeetingPO.way" id="way" valid="{must:true,tip:'会议召开方式',fieldType:'pattern'}"/>
            </td>
        </tr>
        <tr>
            <td class="tdBlue"><span style="color: red">*</span>&nbsp;会议时间</td>
            <td>开始
				<input
        ...
        <tr>
            <td class="tdBlue"><span style="color: red">*</span>&nbsp;会议地点</td>
            <td>
            	<input type="text" id="title" name="tbMeetingPO.address" valid="{must:true,tip:'会议地点',fieldType:'pattern'}"/>&nbsp;&nbsp;&nbsp;
            	<span style="color: red">*</span>
            </td>
        </tr>
        <tr>
            <td class="tdBlue"><span style="color: red">*</span>&nbsp;发布组织</td>
            <input type="hidden" name="tbMeetingPO.organizationid"/>
        ...
        <tr>
            <td class="tdBlue"><span style="color: red">*</span>&nbsp;会议内容</td>
            <td >
               <textarea rows="5" cols="80" name="tbMeetingPO.content" id="content" valid="{must:true,tip:'会议内容',fieldType:'pattern'}"></textarea>
            </td>
        </tr>
        <tr>
            <td class="tdBlue">短信通知</td>
            <td >
               <input type="checkbox" style="width: 15px;height: 10px;" name="tbMeetingPO.smsNotice" id="smsNotice" />
...
<div class="toolBar">
    <div align="center">
    	<input class="greenbtn mr10" type="button" id="save" permission="meetingEdit" value="保存"/>&nbsp;
 ...
 function updateUser() {
    ...
    function flashIframe_GDZC(){
    	...
    	{	
    		...
    		{
    			i.style.height = (document.body.scrollHeight+40)+"px";
    		}
    	}
    }
</script>
