...
<jsp:include page="../../../../common/dqdp_vars.jsp">
    ...
    <jsp:param name="permission" value="meetingRecord"></jsp:param>
</jsp:include>
<head>
...
<form action="${baseURL}/meeting/meetingAction!ajaxSaveRecord.action" method="post" id="id_form_search">
    <div class="searchWrap">
        <div class="title">
            <h2 class="icon1">会议记录</h2>
        </div>
    </div>
    <div class="text_bg noneborder" id="bt">
    <table class="tableCommon mt5" width="100%" border="0" cellspacing="0" cellpadding="0" dataSrc="${baseURL}/meeting/meetingAction!ajaxUserDetails.action?id=${param.id}">
        <tbody>
        <tr>
            <td class="tdBlue">标题<input type="hidden" name="tbMeetingPO.id" id="meetingId"/></td>
            <td name="tbMeetingPO.title">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td class="tdBlue">会议记录</td>
            <td>
               <textarea rows="6" cols="100" name="tbMeetingPO.record" id="content"></textarea>
            </td>
        </tr>
        </tbody>
    </table>
...
<div class="toolBar">
    <div align="center">
    	<input class="greenbtn mr10" type="button" id="save" permission="meetingRecord" value="完成"/>&nbsp;
