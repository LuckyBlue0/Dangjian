...
<jsp:include page="../../../common/dqdp_vars.jsp">
    ...
    <jsp:param name="permission" value="volunteerAdd"></jsp:param>
</jsp:include>
<head>
...
<form action="${baseURL}/volunteer/volunteerAction!ajaxSave.action" method="post" id="id_form_search">
    ...
    <table class="tableCommon mt5" width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            <td class="tdBlue"><span style="color: red">*</span>&nbsp;志愿活动内容</td>
            <td >
               <textarea rows="6" cols="80" name="tbVolunteerActivityPO.content" id="content" valid="{must:true,tip:'志愿活动内容',fieldType:'pattern'}"></textarea>
            </td>
        </tr>
        </tbody>
    </table>
...
<div class="toolBar">
    <div align="center">
    	<input class="greenbtn mr10" type="button" id="draft" onclick="save()" permission="volunteerAdd" value="保存"/>&nbsp;
