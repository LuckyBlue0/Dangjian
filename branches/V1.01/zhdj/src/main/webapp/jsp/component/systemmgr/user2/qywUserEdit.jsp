    ...
    <table class="tableCommon mt5" dataSrc="${baseURL}/person/person!viewBaseUserVO.action?personId=${param.personId}" width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="280"><input class="form120px" name="myPersonMap.ext1_desc" type="text"/></td>
            </tr>
            <tr>
                ...
                <td width="120" class="tdBlue">用户账户：</td>
                <td width="280"><input class="form120px" name="baseUserVO.userName" disabled="true"/></td>
            </tr>
            <tr>
