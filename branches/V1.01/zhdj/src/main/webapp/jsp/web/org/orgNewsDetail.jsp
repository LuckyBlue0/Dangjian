...
<!--头部-->
<!--正文-->
<div id="main" datasrc="${baseURL}/orgIndex/orgIndexAction!searchNewsDetail.action?orgId=${param.orgId}&id=${param.id}&newInfoType=1">
    <div class="loginWrap">
        <div class="wrapper">
            <div class="loginBox clearfix">
                <div class="fl">
                    <div id="position">
                        ...
                        <a href="${baseURL}/jsp/web/org/orgNewsList.jsp?orgId=${param.orgId}">通知公告</a>&nbsp;>&nbsp;<span>公告详情</span>
                ...
                <div class="artlist mt30">
                    <ul>
                        <li>
                            ...
                            <a id="pUrl" href="${baseURL}/jsp/web/org/orgNewsDetail.jsp?id=@{partalNews.newsInfoId}&orgId=${param.orgId}"><span name="partalNews.title"></span></a>
                        </li>
                        <li>
                            <span>下一篇：</span>
                            <input type="hidden" id="nId" name="nextNews.newsInfoId"/>
                            <a id="nUrl" href="${baseURL}/jsp/web/org/orgNewsDetail.jsp?id=@{nextNews.newsInfoId}&orgId=${param.orgId}"><span name="nextNews.title"></span></a>
                        </li>
                    </ul>
                </div>
            </div>
