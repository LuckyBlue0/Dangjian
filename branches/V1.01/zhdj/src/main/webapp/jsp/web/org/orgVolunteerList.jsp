	...
	<body>
		...
		<div id="main">
			...
			<div class="wrapper clearfix mt20" id="list"
				datasrc="${baseURL}/orgIndex/orgIndexAction!ajaxVolunteerSearch.action?searchValue.organizationId=${param.orgId}&searchValue.status=2">
					...
					<div class="notice-bd mt20">
						<ul class="ml15" name="pageData">
							<li class="clearfix">
								<p>
									<a
										href="${baseURL}/jsp/web/org/orgVolunteerDetail.jsp?orgId=${param.orgId}&id=@{id}">@{title}</a>
								</p>
...
function doSearch($pageIndex) {
	...
	$('#list')
			.attr(
					"datasrc",
					"${baseURL}/orgIndex/orgIndexAction!ajaxVolunteerSearch.action?searchValue.organizationId=${param.orgId}&searchValue.status=2&page="
							+ page);
	_redraw("list");
	initPageBar();
}
