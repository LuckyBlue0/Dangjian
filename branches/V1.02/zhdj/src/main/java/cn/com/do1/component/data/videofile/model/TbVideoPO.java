package cn.com.do1.component.data.videofile.model;
...
* User: ${user}
*/
public class TbVideoPO implements IBaseDBVO {
    ...
    @PageView(showName="type",showType="input",showOrder=3,showLength=22)
     @DictDesc(refField = "type", typeName = "videoType")
