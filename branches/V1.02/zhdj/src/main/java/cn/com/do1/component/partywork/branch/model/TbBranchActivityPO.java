 ...
 */
public class TbBranchActivityPO implements IBaseDBVO {
	...
	@PageView(showName = "address", showType = "input", showOrder = 8, showLength = 200)
	private java.lang.String address;
	@Validation(must = false, length = 1000, fieldType = "pattern", regex = "^.*$")
	@PageView(showName = "content", showType = "input", showOrder = 9, showLength = 1000)
	private java.lang.String content;
	@Validation(must = false, length = 200, fieldType = "pattern", regex = "^.*$")
	@PageView(showName = "imgPath", showType = "input", showOrder = 10, showLength = 200)
