package cn.com.do1.component.partywork.democrticlife.model;
 ...
 */
public class TbDemocraticLifePO implements IBaseDBVO {
	...
	@PageView(showName = "whetherEnd", showType = "input", showOrder = 3, showLength = 22)
	...
	@PageView(showName = "record", showType = "editor", showOrder = 8, showLength = 4000)
	@LargeObject
	private String record;
	@Validation(must = false, length = 200, fieldType = "pattern", regex = "^.*$")
	@PageView(showName = "imgPath", showType = "input", showOrder = 9, showLength = 200)
	private java.lang.String imgPath;
	@Validation(must = false, length = 200, fieldType = "pattern", regex = "^.*$")
	@PageView(showName = "qrCode", showType = "input", showOrder = 10, showLength = 200)
	private java.lang.String qrCode;
	@Validation(must = false, length = 22, fieldType = "pattern", regex = "^.*$")
	@PageView(showName = "smsNotice", showType = "input", showOrder = 11, showLength = 22)
	...
	@Validation(must = false, length = 22, fieldType = "pattern", regex = "^.*$")
	@PageView(showName = "auditStatus", showType = "input", showOrder = 14, showLength = 22)
	private java.lang.Long auditStatus;
	@Validation(must = false, length = 36, fieldType = "pattern", regex = "^.*$")
	@PageView(showName = "auditUserId", showType = "input", showOrder = 15, showLength = 36)
	private java.lang.String auditUserId;
	@Validation(must = false, length = 7, fieldType = "datetime", regex = "")
	@PageView(showName = "auditTime", showType = "datetime", showOrder = 16, showLength = 7)
	@FormatMask(type = "date", value = "yyyy-MM-dd HH:mm:ss")
	private java.util.Date auditTime;
	@Validation(must = false, length = 36, fieldType = "pattern", regex = "^.*$")
	@PageView(showName = "pushUserId", showType = "input", showOrder = 17, showLength = 36)
	private java.lang.String pushUserId;
	@Validation(must = false, length = 7, fieldType = "datetime", regex = "")
	@PageView(showName = "pushTime", showType = "datetime", showOrder = 18, showLength = 7)
	@FormatMask(type = "date", value = "yyyy-MM-dd HH:mm:ss")
	private java.util.Date pushTime;
	@Validation(must = false, length = 22, fieldType = "pattern", regex = "^.*$")
	@PageView(showName = "status", showType = "input", showOrder = 19, showLength = 22)
