    ...
    <table class="tableCommon mt5" width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                	<select name="tbNewsColumnTypePO.parentId" id="parentNewsType">
                	</select>
                </td>
            </tr>
            <tr>
...
<div class="toolBar">
    <div align="center">
        <input class="greenbtn mr10" type="button" permission="newsTypeAdd" onclick="doSave();" value="保存"/>
