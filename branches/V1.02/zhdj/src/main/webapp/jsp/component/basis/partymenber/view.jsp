				...
				<table class="tableCommon mt5" width="100%" border="0"
					...
					<tbody>
						...
						<tr>
							...
							<td width="30%" colspan="3" name="partyMenberInfoVO.nativePlace">
							</td>
						</tr>
						<tr>
							<td width="130" class="tdBlue">
							...
							<td width="30%" colspan="3"
								name="partyMenberInfoVO.organizationName">
							</td>
						</tr>
						<tr>
							<td width="130" class="tdBlue">
							...
							<td width="30%" name="partyMenberInfoVO.degreeDesc">
							</td>
							<td width="130" class="tdBlue" id="degreeInTD1">
								学位
							</td>
							<td width="30%" id="degreeInTD2"
								name="partyMenberInfoVO.degreeInDesc">
							</td>
						</tr>
						<tr>
							<td width="130" class="tdBlue">
							...
							<td width="30%" name="partyMenberInfoVO.idCard">
							</td>
							<td width="130" class="tdBlue">
								民族
							</td>
							<td width="30%" name="partyMenberInfoVO.national">
							</td>
						</tr>
						<tr>
							<td width="130" class="tdBlue">
							...
							<td width="30%" name="partyMenberInfoVO.birthday">
							</td>
							<td width="130" class="tdBlue">
								入党时间
							</td>
							<td width="30%" name="partyMenberInfoVO.partyTime">
							</td>
						</tr>
						<tr>
							<td width="130" class="tdBlue">
							...
							<td width="30%" name="partyMenberInfoVO.affairsWorkerDesc">
							</td>
							<td width="130" class="tdBlue">
								是否党代表
							</td>
							<td width="30%" name="partyMenberInfoVO.behalfDesc">
							</td>
						</tr>
						<tr>
							<td width="130" class="tdBlue">
							...
							<td width="30%" name="partyMenberInfoVO.volunteersDesc">
							</td>
							<td width="130" class="tdBlue">
								是否困难党员
							</td>
							<td width="30%" name="partyMenberInfoVO.hardPartyMembersDesc">
							</td>
						</tr>
						<tr>
							<td width="130" class="tdBlue">
							...
							<td width="30%" name="partyMenberInfoVO.userTypeDesc">
							</td>
							<td width="130" class="tdBlue">
								是否管理员
							</td>
						...
						<tr>
							...
							<td width="30%" colspan="3" name="partyMenberInfoVO.homeAddress">
							</td>
						</tr>
						<tr>
							<td width="130" class="tdBlue">
							...
							<td colspan="3" name="partyMenberInfoVO.note">
							</td>
						</tr>
					</tbody>
				</table>
