...
<form action="${baseURL}/dqdpconfig/config!update.action" method="post" id="id_form_add">
    <div class="searchWrap">
            <div class="title">
                <h2 class="icon1">修改配置</h2>
            </div>
        </div>
    <div class="text_bg" id="bt">
    <table class="tableCommon mt5" width="100%" border="0" cellspacing="0" cellpadding="0"
           dataSrc="${baseURL}/dqdpconfig/config!getConfig.action?ids=${param.id}">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td >
                    ...
                    <input  class="form120px" name="configVO.configValue" type="text" valid="{length:300,tip:'配置值'}"/>
                </td>
            </tr>
            <tr>
...
<script type="text/javascript">
    function doSave() {
        if(_doCommonSubmit("id_form_add", null, {ok:function(){history.back()},fail:function(){}}));
//        history.back();
    }
</script>
</body>
