...
<body>
<form method="post" id="id_form_search" dataSrc="${baseURL}/news/newsinfo/newsInfoAction!ajaxPreview.action?newsInfoId=${param.newsInfoId}">
    <div class="wrapper">
        <div class="article pt40">
            ...
            <input type="hidden" name="tbNewsInfoPO.imgPath" id="imgPath" />
            <center>
            <img align="middle" style="display: none;" src="" alt="" id="pic" /></center>
