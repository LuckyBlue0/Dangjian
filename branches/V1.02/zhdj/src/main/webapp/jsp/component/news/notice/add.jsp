...
<jsp:include page="../../../common/dqdp_vars.jsp">
    <jsp:param name="dict" value="newsInfoBuyTop"></jsp:param>
    <jsp:param name="permission" value="noticeAfficheAdd"></jsp:param>
</jsp:include>
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>通知公告信息录入</title>
...
<form action="${baseURL}/news/newsinfo/newsInfoAction!ajaxSave.action" method="post" id="id_form_search">
    <table class="tableCommon mt5" width="100%" border="0" cellspacing="0" cellpadding="0" >
        ...
        <tr>
            ...
            <td width="100" >
            	<input type="hidden" name="tbNewsInfoPO.newsInfoType" value="${param.newsInfoType}"/>
                <input type="text" id="title" style="width:400px" name="tbNewsInfoPO.title" valid="{must:true,tip:'标题',fieldType:'pattern'}"/>&nbsp;&nbsp;&nbsp;
                <input id="status"  name="tbNewsInfoPO.status" type="checkbox" >&nbsp;已发布&nbsp;&nbsp;&nbsp;
        ...
        <tr>
            ...
            <td colspan="3">
               <textarea rows="10" cols="120" name="tbNewsInfoPO.content" id="content" ></textarea>
            </td>
        </tr>
        </tbody>
    </table>
...
<div class="toolBar">
    <div align="center">
    	<input class="btn4" type="button" id="save" permission="noticeAfficheAdd" value="保存并预览"/>&nbsp;
    	<input class="btn4" type="button" id="push" permission="noticeAfficheAdd" value="发布"/>&nbsp;
    ...
    if (dqdp.submitCheck("id_form_search")) {
        ...
        $('#id_form_search').ajaxSubmit({
            ...
            success:function(result) {
                if ("0"==result.code) {
                    alert('新增成功');
                    window.location.href="list.jsp?type=${param.newsInfoType}";
