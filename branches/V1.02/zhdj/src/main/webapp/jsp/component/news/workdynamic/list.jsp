...
<jsp:include page="../../../common/dqdp_vars.jsp">
    ...
    <jsp:param name="permission" value="workDynamicheSearch,workDynamicheView,workDynamicheAdd,workDynamicheEdit,workDynamicheDel"></jsp:param>
                            ...
                            <td>
                                <table class="search" width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                        ...
                                        <td><input class="btnQuery" name="search" type="button" value="查询" permission="workDynamicheSearch"
...
<!--翻页 end-->
    ...
    <div class="operation">
       <input class="btnS4" type="button" permission="workDynamicheAdd" value="新增" onclick="javascript:window.location.href='add.jsp'+ '?dqdp_csrf_token='+dqdp_csrf_token+'&newsInfoType=${param.type}'"/>
       <input class="btnS4" type="button" permission="workDynamicheDel" value="删除" onclick="javascript:_doDel('newsInfo_list');doSearch(1);"/>
   </div>
                    ...
                    var list1 = new ListTable(
                            {
                                ...
                                title:[
                                    {width:"5%", name:"newsInfoId", showName:"", isCheckColunm:true,
                                    ...
                                    {width:"15%", name:"title", showName:"标题"},
                                ...
                                operations:[
                                    {name:"点击预览", permission:"workDynamicheView", event:function (index, content) {
                                        window.location.href = 'view.jsp?newsInfoId=' + content.newsInfoId+ '&dqdp_csrf_token='+dqdp_csrf_token;
                                    }},
                                    {name:"修改", permission:"workDynamicheEdit", event:function (index, content) {
                                        window.location.href = 'edit.jsp?newsInfoId=' + content.newsInfoId+ '&dqdp_csrf_token='+dqdp_csrf_token;
                                    }},
	                                {name:"删除", permission:"workDynamicheDel", condition:function (index, content) {
