...
<jsp:include page="../../../common/dqdp_vars.jsp">
    <jsp:param name="dict" value="meetingSmsNotice"></jsp:param>
    <jsp:param name="permission" value="democrticlifeAdd"></jsp:param>
</jsp:include>
<head>
...
<form action="${baseURL}/democrticLife/democrticLifeAction!ajaxSave.action" method="post" id="id_form_search">
    ...
    <table class="tableCommon mt5" width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
            ...
            <td >
            	<input type="hidden" name="tbDemocraticLifePO.id"/>
                <input type="text" id="title" name="tbDemocraticLifePO.title" valid="{must:true,tip:'活动标题',fieldType:'pattern'}"/>&nbsp;&nbsp;&nbsp;
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td >
            	<input type="text" id="address" name="tbDemocraticLifePO.address" valid="{must:true,tip:'活动地点',fieldType:'pattern'}"/>&nbsp;&nbsp;&nbsp;
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td >
               <input type="checkbox" style="width: 15px;height: 10px;" value="1" name="tbDemocraticLifePO.smsNotice" id="smsNotice" />
...
<div class="toolBar">
    <div align="center">
    	<input class="greenbtn mr10" type="button" id="save" permission="democrticlifeAdd" value="保存"/>&nbsp;
