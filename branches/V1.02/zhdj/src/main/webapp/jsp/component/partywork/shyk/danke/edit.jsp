...
<jsp:include page="../../../../common/dqdp_vars.jsp">
    ...
    <jsp:param name="permission" value="dangkeEdit"></jsp:param>
</jsp:include>
<head>
...
<form action="${baseURL}/meeting/dangkeAction!ajaxSave.action" method="post" id="id_form_search">
    <table class="tableCommon mt5" width="100%" border="0" cellspacing="0" cellpadding="0" dataSrc="${baseURL}/meeting/dangkeAction!ajaxView.action?id=${param.id}">
        ...
        <tr>
            ...
            <td >
               <textarea rows="5" cols="80" name="tbMeetingPO.content" id="content" ></textarea>
            </td>
        </tr>
        <tr>
...
<div class="toolBar">
    <div align="center">
    	<input class="btn4" type="button" id="save" permission="dangkeEdit" value="保存并发布"/>&nbsp;
