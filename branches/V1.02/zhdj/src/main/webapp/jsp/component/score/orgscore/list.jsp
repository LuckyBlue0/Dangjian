...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<jsp:include page="../../../common/dqdp_vars.jsp">
		...
		<jsp:param name="permission"
			value="orgScoreManager,orgScoreSearch,orgScoreView,orgScoreExport,orgScoreEdit"></jsp:param>
	...
	<body style="background: #f6ebe5;">
		...
		<div class="text_bg">
			<form action="${baseURL}/orgscore/orgscoreAction!ajaxSearch.action"
												...
												<tr>
													...
													<td align="right">
														<input class="btnQuery" name="search" type="button"
															value="查询" permission="orgScoreSearch"
...
function _doExport(formId) {
	$
			.ajax( {
				...
				url : '${baseURL}/orgscore/orgscoreAction!ajaxBatchExport.action',
				type : 'post',
				dataType : 'json',
...
function doSearch($pageIndex) {
	$('#form_search').ajaxSubmit(
			...
			<div id="personalScore_list"
				delUrl="${baseURL}/orgscore/orgscoreAction!ajaxSearch.action"></div>
			<div id="tip"></div>
