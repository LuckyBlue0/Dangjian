...
<div class="searchWrap">
  ...
  <div class="text_bg" style="height: 600px;">
...
//    orgTree.reAsyncChildNodes(orgTreeNode, "refresh");
    ...
    function viewOrgNode(event, treeId, treeNode) {
    	window.opener.document.getElementById("parentId").value = treeNode.id;
	    window.opener.document.getElementById("parentName").value = treeNode.organizationName ;
	    window.close();
    }
