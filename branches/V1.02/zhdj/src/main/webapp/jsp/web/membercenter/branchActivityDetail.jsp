...
<div id="main" style="display: none">
            ...
            <div class="activity_right fl mt10 pb20" dataSrc="${baseURL}/branch/branchAction!ajaxView.action?id=${param.id}">
            
                <div class="act_top">活动详情</div>
                <div class="act_bd">
                    <div class="act_tabWrap mt10">
                        <div class="act_tab_bd">
                            <table class="mycouse">
                            <input type="hidden" name="tbBranchActivityPO.id" id="meetingId"/>
                                <thead>
                                <tr>
                                    <td colspan="4" name="tbBranchActivityPO.title"></td>
                                </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <th width="20%"  style="text-align: right;" >活动开始时间</th>
                                        <td width="30%" name="tbBranchActivityPO.startTime"></td>
                                        <th style="text-align: center;"  width="20%">活动结束时间</th>
                                        <td width="30%" name="tbBranchActivityPO.endTime"></td>
                                    </tr>
                                    <tr>
                                        <th  style="text-align: right;">发布组织</th>
                                        <td name="tbBranchActivityPO.organizationName"></td>
                                        <th style="text-align: center;">活动类型</th>
                                        <td name="tbBranchActivityPO.typeDesc"></td>
                                    </tr>
                                    <tr>
                                        <th  style="text-align: right;">活动地点</th>
                                        <td colspan="3" name="tbBranchActivityPO.address"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" width="550px" name="tbBranchActivityPO.content"></td>
                                    </tr>
                                </tbody>
                            </table>
                            <div class="mt10 tc">
                                <input type="button" value="我要请假" showOn="@{tbBranchActivityPO.status}==1" onclick="updateStatus('@{tbBranchActivityPO.id}','1')" class="btnyellow mr30"/>
                                <!-- <input type="button" value="签到" showOn="@{tbBranchActivityPO.status}==1" onclick="updateStatus('@{tbBranchActivityPO.id}','2')" class="btnstore"/> -->
...
function listUserByMeetingId() {
	    $.ajax({
	        url: "${baseURL}/branch/branchAction!ajaxUser.action", 
