	...
	<body>
		...
		<div id="main">
			...
			<div class="wrapper clearfix mt20" id="list"
				datasrc="${baseURL}/orgIndex/orgIndexAction!ajaxHotNewsSearch.action?searchValue.organizationId=${param.orgId}">
					...
					<div class="notice-bd mt20">
						<ul class="ml15" name="pageData">
							<li class="clearfix">
								<p>
									<a
										href="${baseURL}/jsp/web/org/orgHotNewsDetail.jsp?orgId=${param.orgId}&id=@{newsInfoId}">@{title}</a>
								</p>
...
function doSearch($pageIndex) {
	...
	$('#list')
			.attr(
					"datasrc",
					"${baseURL}/orgIndex/orgIndexAction!ajaxHotNewsSearch.action?searchValue.organizationId=${param.orgId}&page="
							+ page);
	_redraw("list");
	initPageBar();
}
