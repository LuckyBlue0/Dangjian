...
- (NSString *) macaddress;
@end
@implementation UIDevice (DOUIDeviceAdditions)
- (NSString *) macaddress{
    int                 mib[6];
    size_t              len;
    char                *buf;
...
-(NSString*)appVersion{
    ...
    if ([[infoDictionary objectForKey:@"CFBundleShortVersionString"] isKindOfClass:[NSString class]]) {
...
//-(void)isCall{
//	/*
//	 注意要加头文件目录 /System/Library/Frameworks/CoreTelephony.framework/Headers 
//	 到 build 设置 Header Search Paths，并在使用到这些类中加头文件
//	 */
