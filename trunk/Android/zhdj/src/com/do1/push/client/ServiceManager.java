...
public final class ServiceManager {
    ...
    public ServiceManager(Context context) {
        ...
        //        Log.i("apiKey=" + apiKey);
        //        //        if (apiKey == null) {
        //        //            Log.e("Please set the androidpn api key in the manifest file.");
        ...
        Log.i("apiKey=" + apiKey);
        Log.i("xmppHost=" + xmppHost);
        Log.i("xmppPort=" + xmppPort);
        ...
        editor.commit();
        // Log.i("sharedPrefs=" + sharedPrefs.toString());
    }
    ...
    private Properties loadProperties() {
        ...
        //                props.load(in);
        //            } else {
        //                Log.e("Could not find the properties file.");
        //            }
        //        } catch (IOException e) {
