...
import com.do1.zhdj.util.ImageBase64Util;
import com.do1.zhdj.util.ImageViewTool;
import com.do1.zhdj.util.Listenertool;
import com.do1.zhdj.util.SDCardUtil;
...
public class PersonInfoActivity extends BaseActivity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		context = this;
		aq = new AQuery(this);
		setHeadView(findViewById(R.id.headLayout), R.drawable.btn_back_thzhd,"", "2".equals(constants.userInfo.getUser_type()) ? "我的主页" : "个人信息", R.drawable.btn_head_2,"编辑", this, this);
