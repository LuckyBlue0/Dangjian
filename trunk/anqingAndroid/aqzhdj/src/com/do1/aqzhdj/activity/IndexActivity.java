...
import com.do1.aqzhdj.activity.bbs.BBSindexActivity;
import com.do1.aqzhdj.activity.infomation.InfomationActivity;
import com.do1.aqzhdj.activity.mine.MineNewActivity;
import com.do1.aqzhdj.activity.mine.PersonInfoActivity;
import com.do1.aqzhdj.activity.mine.minsheng.MinshengActivity;
import com.do1.aqzhdj.activity.study.StudyActivity;
...
public class IndexActivity extends BaseTabActivity {
	...
	private void setupTab() {
		...
		Intent intent2 = new Intent(this, BBSindexActivity.class);
		// intent3.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		addTab("互动", R.id.tab2, intent2);
		...
		if ("2".equals(constants.userInfo.getUser_type())) {// type=2为群众用户，1为党员用户
			...
			intent3.setClass(this, MineNewActivity.class);
		}
		addTab("个人", R.id.tab3, intent3);

		

		Intent intent4 = new Intent(this, StudyActivity.class);
		// intent4.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		addTab("办公", R.id.tab4, intent4);
		
		Intent intent5 = new Intent(this, MinshengActivity.class);
		// intent4.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
		addTab("民生", R.id.tab5, intent5);
