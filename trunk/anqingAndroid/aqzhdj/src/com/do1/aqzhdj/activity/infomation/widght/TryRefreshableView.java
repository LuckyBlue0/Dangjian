package com.do1.aqzhdj.activity.infomation.widght;
...
/**
 * TODO:参考了网上Nono的代码 User:YanFangqin Date:2013-5-23 ProjectName:thzhd
 */
		...
		if (nowpull == 0 && mRefreshState != REFRESHING) {
			...
			if (refreshFooter >= 20
				...
				if (refreshFooter >= 0)
					...
					TryPullToRefreshScrollView.ScrollToPoint(sv, sv
							.getChildAt(0), -refreshFooter);
				}
			}
		}
	}
