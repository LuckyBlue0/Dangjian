...
import com.do1.aqzhdj.activity.bbs.BBSOfficeListActivity;
...
import com.do1.aqzhdj.activity.mine.branch.BranchActivity;
import com.do1.aqzhdj.activity.mine.my.MyToDoListActivity;
...
public class MineNewActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		context = this;
		aq = new AQuery(this);
		setHeadView(findViewById(R.id.headLayout), 0, "", "个人中心",
				R.drawable.btn_head_2, "注销登录", null, this);
		init();
...
//			doRequest(100, testurl, test);
		...
		case R.id.xuexiceshiLayout:
			intent = new Intent(context, BBSOfficeListActivity.class);
			intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
			startActivity(intent);
//			Toast.makeText(this, "此模块正在建设中...", 0).show();
			break;
