...
import com.barcode.zxing.camera.CameraManager;
import com.barcode.zxing.result.ResultHandler;
import com.barcode.zxing.result.ResultHandlerFactory;
...
public final class CaptureActivity extends BaseActivity implements SurfaceHolder.Callback {
  ...
  private static final String PRODUCT_SEARCH_URL_PREFIX = "http://www.baidu.com";
...
//    type = this.getIntent().getStringExtra("type");
   ...
   /* historyManager = new HistoryManager(this);
    ...
    setHeadView(findViewById(R.id.headLayout), R.drawable.btn_back_thzhd, "", "二维码签到", 0,"", null, null);
  }
...
public void onResume() {
  ...
  //  resultView.setVisibility(View.VISIBLE);
    ...
    /*Log.e(TAG,"����:0"+arrays[0]);
    Log.e(TAG,"����:1"+arrays[1]);
    Log.e(TAG,"����:2"+arrays[2]);*/
    
    Intent intent = new Intent(CaptureActivity.this, DecodeResultActivity.class);
    Constants.mBitmap = barcode;
    intent.putExtra("content", displayContents.toString());
  ...
  //  Log.e(TAG,"XXXXXXXX:"+displayContents);
