...
//            String path = Environment.getExternalStorageDirectory().getPath();
			...
			String mapjson = com.do1.aqzhdj.util.Constants.sharedProxy.getString(AppManager.PUSH_KEY, "{}");
			try {
				...
				com.do1.aqzhdj.util.Constants.sharedProxy.putString(AppManager.PUSH_KEY, json.toString());
				com.do1.aqzhdj.util.Constants.sharedProxy.commit();
			...
			Intent intent;
			if(com.do1.aqzhdj.util.Constants.loginInfo != null && com.do1.aqzhdj.util.Constants.loginInfo.isLogin()){
