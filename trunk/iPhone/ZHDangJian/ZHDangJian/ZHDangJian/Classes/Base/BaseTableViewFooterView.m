...
-(id)initWithFrame:(CGRect)frame{
    if (self=[super initWithFrame:frame]) {
        ...
        tipLabel.backgroundColor = CLEAR_COLOR;
        ...
        UITapGestureRecognizer *aKeyword = [[[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(tapAction)]autorelease];
