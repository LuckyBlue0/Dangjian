...
@interface LifestyleResultVC ()

@end

@implementation LifestyleResultVC
...
- (void)creatSignModel
{
    ...
    [aDic setObject:[[NSString stringWithFormat:@"%@%@3", self.idString, [UserInfo sharedInstance].userId] MD5] forKey:@"digest"];
