...
@interface MeetingSignResultVC ()

@end

@implementation MeetingSignResultVC
...
- (void)creatSignModel
{
    ...
    [aDic setObject:[[NSString stringWithFormat:@"%@%@1", self.idString, [UserInfo sharedInstance].userId] MD5] forKey:@"digest"];
