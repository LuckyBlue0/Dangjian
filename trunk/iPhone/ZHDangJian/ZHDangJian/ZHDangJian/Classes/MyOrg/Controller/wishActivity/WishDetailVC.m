...
- (void)setDataAndLayout
{
    ...
    self.senderPersonLabel.text = [NSString stringWithFormat:@"发起人：%@", [[self.dataDic objectForKey:@"details"] objectForKey:@"createUserName"]];
