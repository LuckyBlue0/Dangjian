package cn.com.do1.component.data.partyfile.model;
...
* User: ${user}
*/
public class TbPartyFilePO implements IBaseDBVO {
    ...
    @DictDesc(refField = "type", typeName = "partyType")
