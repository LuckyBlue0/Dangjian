...
<form action="${baseURL}/datafile/datafileAction!ajaxUpdate.action" method="post" id="org_add" enctype="multipart/form-data">
<div class="searchWrap">
    ...
    <table class="tableCommon mt5" width="100%" border="0" cellspacing="0" cellpadding="0" datasrc="${baseURL}/datafile/datafileAction!ajaxView.action?id=${param.id}">
       <input type="hidden" name="tbDatafilePO.id"/>
        <input type="hidden" name="tbDatafilePO.fileSize" id="fileSize"/>

        <tbody>
            <tr>
                <td class="tdBlue"><span><font color="red">*</font></span>文件类型</td>
                <td>
                    <select class="form120px"  name="tbDatafilePO.type" dictType="dataType"
            ...
            <tr>
                ...
                <td>
                    <input class="form120px"  name="tbDatafilePO.fileName" id="fileName"  type="text" 
            ...
            <tr>
                ...
                <td>
                   ...
                   <input name="tbDatafilePO.filePath" id="imgPath" class="form120px"  type="hidden"   />&nbsp; 
            ...
            <tr>
                ...
                <td>
                <textarea rows="3" name="tbDatafilePO.remark"  valid="{must:false,tip:'文件说明',length:2000}" ></textarea>
                </td>
            </tr>
...
<script type="text/javascript">
        ...
        if (dqdp.submitCheck("org_add")) {
                    ...
                    success:function (result) {
                        if ("0" == result.code) {
                            alert('修改成功'); 
                            if(""!=$("#file").val()){
                                 window.location.href=("dataFileList.jsp?filePath="+$("#imgPath").val()+"&fileName="+$("#fileName").val()); 
                            }else{
                            	 window.location.href=("dataFileList.jsp");
                            }
                        } else {
                            alert(result.desc);
                        }
   ...
   function uploadFile(){
	  // $('#org_add').attr("action","${baseURL}/videofile/videofileAction!uploadFile.action?dir=videoFile"); 
	   ...
	   $('#org_add').attr("action","${baseURL}/progressUpload?dir=dataFile"); 
	   var myDate = new Date();
		...
		$("#progress").show();
	     ...
	     $('#org_add').attr("action","${baseURL}/datafile/datafileAction!ajaxUpdate.action"); 
   }
</script>
