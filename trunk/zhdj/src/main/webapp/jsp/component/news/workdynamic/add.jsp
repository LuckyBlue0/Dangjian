...
<jsp:include page="../../../common/dqdp_vars.jsp">
    ...
    <jsp:param name="permission" value="workDynamicheAdd"></jsp:param>
</jsp:include>
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>工作动态信息录入</title>
...
<div class="toolBar">
    <div align="center">
    	<input class="btn4" type="button" id="save" permission="workDynamicheAdd" value="保存并预览"/>&nbsp;
    	<input class="btn4" type="button" id="push" permission="workDynamicheAdd" value="发布"/>&nbsp;
