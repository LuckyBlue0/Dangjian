...
<form action="${baseURL}/partyLecture/partyLectureAction!ajaxSave.action" method="post" id="id_form_search">
    ...
    <table class="tableCommon mt5" width="100%" border="0" cellspacing="0" cellpadding="0" dataSrc="${baseURL}/partyLecture/partyLectureAction!ajaxViewDetails.action?id=${param.id}">
        ...
        <tr>
            <td class="tdBlue"><span style="color: red">*</span>&nbsp;参与人员</td>
            <td>
        ...
        <tr>
            ...
            <td >
               <input type="checkbox" style="width: 15px;height: 10px;" name="tbPartyLecturePO.smsNotice" id="smsNotice" />
...
<div class="toolBar">
    <div align="center">
    	<input class="greenbtn mr10" type="button" id="save" permission="partyLectureEdit" value="保存"/>&nbsp;
