...
<jsp:include page="../../../../common/dqdp_vars.jsp">
    ...
    <jsp:param name="permission" value="partyLectureRecord"></jsp:param>
</jsp:include>
<head>
...
<form action="${baseURL}/partyLecture/partyLectureAction!ajaxSaveRecord.action" method="post" id="id_form_search">
    <div class="searchWrap">
        <div class="title">
            <h2 class="icon1">党课记录</h2>
        </div>
    </div>
    <div class="text_bg noneborder" id="bt">
    <table class="tableCommon mt5" width="100%" border="0" cellspacing="0" cellpadding="0" dataSrc="${baseURL}/partyLecture/partyLectureAction!ajaxViewDetails.action?id=${param.id}">
        <tbody>
        <tr>
            <td class="tdBlue">标题<input type="hidden" name="tbPartyLecturePO.id" id="partyLectureId"/></td>
            <td name="tbPartyLecturePO.title">
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
               <textarea rows="6" cols="100" name="tbPartyLecturePO.record" id="record"></textarea>
            </td>
        </tr>
        </tbody>
    </table>
...
<div class="toolBar">
    <div align="center">
    	<input class="greenbtn mr10" type="button" id="save" permission="partyLectureRecord" value="完成"/>&nbsp;
 ...
 var userMap = new HashMap();
  ...
  $(document).ready(function(){
	  ...
	  KindEditor.ready(function(K) {
			editor1 = K.create('textarea[name="tbPartyLecturePO.record"]', {
			...
			afterCreate : function() {
	            ...
	            this.sync(); 
	            $('#id_form_search').find('textarea[name="tbPartyLecturePO.record"]').val(K('textarea[name="tbPartyLecturePO.record"]').val());
	        }  
		})});
  });
