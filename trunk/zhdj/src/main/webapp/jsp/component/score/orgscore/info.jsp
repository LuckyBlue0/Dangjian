...
.tb td {
	...
	<body style="background: #f6ebe5;">
		...
		<div class="text_bg noneborder">
			<form
				action="${baseURL}/orgscore/orgscoreAction!ajaxInfo.action?searchValue.id=${param.id}"
												...
												<tr>
													...
													<td align="right">
														...
														<input class="btnQuery" type="button" value="积分修正"
															onclick="javascript:window.location.href='add.jsp'+ '?dqdp_csrf_token='+dqdp_csrf_token+'&id=${param.id}'" />
													</td>
												</tr>
			...
			<!--角色信息搜索表单 end-->
			<b
				datasrc="${baseURL}/orgscore/orgscoreAction!getOrgScoreByOrgId.action?id=${param.id}">&nbsp;&nbsp;&nbsp;&nbsp;组织名称：<font
				name="organizationScoreVO.organizationName"></font>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;累计积分：<font
				name="organizationScoreVO.accumulativeScore"></font> </b>
...
function _doExport() {
	$
			.ajax( {
				...
				url : '${baseURL}/orgscore/orgscoreAction!ajaxBatchExportInfo.action',
				type : 'post',
				dataType : 'json',
	...
	$('#form_search').ajaxSubmit( {
		...
		success : function(result) {
			if ("0" == result.code) {
				...
				list1.createList("orgScore_list");
				var pager = new Pager( {
		...
		error : function() {
			...
			<div id="orgScore_list"
				delUrl="${baseURL}/orgscore/orgscoreAction!ajaxBatchDelete.action"></div>
			<div id="tip"></div>
