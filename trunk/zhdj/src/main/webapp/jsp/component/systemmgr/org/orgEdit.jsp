 ...
 function flashIframe_GDZC() {
   ...
   function showType($this){
    ...
    $(document).ready(function () {
     ...
     function uploadFile(){
	   $('#org_edit').attr("action","${baseURL}/orgManage/orgManageAction!fileUpload.action");
	    $('#org_edit').ajaxSubmit({
                    dataType:'json',
                    success:function (result) {
                        if ("0" == result.code) {
	     ...
	     $('#org_edit').attr("action","${baseURL}/orgManage/orgManageAction!ajaxUpdate.action");
   }
