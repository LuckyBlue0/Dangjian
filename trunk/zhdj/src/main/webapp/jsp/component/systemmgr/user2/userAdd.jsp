...
<form action="${baseURL}/person/person!addPerson.action" method="post" id="person_add">
    ...
    <table class="tableCommon mt5" width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tbody>
            <tr>
                <td width="120" class="tdBlue"><span><font color="red">*</font></span>人员名称</td>
                <td width="280">
                    <input class="form120px" name="personVO.personName" type="text"
                           valid="{must:true,tip:'人员名称',fieldType:'pattern',length:20}"/>
                    
                </td>
                <td width="120" class="tdBlue"><span><font color="red">*</font></span>登陆账号</td>
                <td width="280">
            ...
            <tr>
                <td width="120" class="tdBlue"> <span><font color="red">*</font></span>密码</td>
                <td width="280">
                ...
                <td width="120" class="tdBlue"><span><font color="red">*</font></span>确认密码</td>
                <td width="280">
            ...
            <tr>
                ...
                <td width="280"><input class="form120px" name="personVO.age" type="text"
                                       valid="{must:false, fieldType:'pattern', regex:'^[1-9]\\d{0,2}$', tip:'年龄'}"/></td>
