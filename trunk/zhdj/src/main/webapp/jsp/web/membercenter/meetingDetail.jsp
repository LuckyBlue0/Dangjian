...
<div id="main" style="display: none">
            ...
            <div class="activity_right fl mt10 pb20" dataSrc="${baseURL}/meeting/meetingAction!ajaxView.action?id=${param.id}">
            
                <div class="act_top">会议详情</div>
                <div class="act_bd">
                    <div class="act_tabWrap mt10">
                        <div class="act_tab_bd">
                            ...
                            <input type="hidden" name="tbMeetingPO.id" id="meetingId"/>
                                <thead>
                                <tr>
                                    <td colspan="4" name="tbMeetingPO.title"></td>
                                </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <th width="20%"  style="text-align: right;" >会议开始时间</th>
                                        <td width="30%" name="tbMeetingPO.startTime"></td>
                                        <th style="text-align: center;"  width="20%">会议结束时间</th>
                                        <td width="30%" name="tbMeetingPO.endTime"></td>
                                    </tr>
                                    <tr>
                                        <th  style="text-align: right;">发布组织</th>
                                        <td name="tbMeetingPO.organizationName"></td>
                                        <th style="text-align: center;">会议类型</th>
                                        <td name="tbMeetingPO.typeDesc"></td>
                                    </tr>
                                    <tr>
                                        <th  style="text-align: right;">会议地点</th>
                                        <td colspan="3" name="tbMeetingPO.address"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3" width="550px" name="tbMeetingPO.content"></td>
                                    </tr>
                                </tbody>
                            </table>
                            <div class="mt10 tc">
                                <input type="button" value="我要请假" showOn="@{tbMeetingPO.status}==1" onclick="updateStatus('@{tbMeetingPO.id}','1')" class="btnyellow mr30"/>
                                <!-- <input type="button" value="签到" showOn="@{tbMeetingPO.status}==1" onclick="updateStatus('@{tbMeetingPO.id}','2')" class="btnstore"/> -->
