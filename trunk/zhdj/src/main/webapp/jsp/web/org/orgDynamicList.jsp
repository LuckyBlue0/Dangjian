	...
	<body>
		...
		<div id="main">
			...
			<div class="wrapper clearfix mt20" id="list"
				datasrc="${baseURL}/orgIndex/orgIndexAction!ajaxDynamicSearch.action?searchValue.organizationId=${param.orgId}&searchValue.whetherEnd=1">
					...
					<div class="notice-bd mt20">
						<ul class="ml15" name="pageData">
							<li class="clearfix">
								<p>
									<a
										href="${baseURL}/jsp/web/org/orgDynamicDetail.jsp?orgId=${param.orgId}&id=@{id}">@{title}</a>
								</p>
...
function doSearch($pageIndex) {
	...
	$('#list')
			.attr(
					"datasrc",
					"${baseURL}/orgIndex/orgIndexAction!ajaxDynamicSearch.action?searchValue.organizationId=${param.orgId}&searchValue.whetherEnd=1&page="
							+ page);
	_redraw("list");
	initPageBar();
}
